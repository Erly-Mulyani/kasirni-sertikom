            ...
            <div class="card-body p-2">
                <div class="row">
                    ...
                    <div class="col-8 mb-2 pl-0">
                        <input type="text" class="form-control form-control-sm bg-white" value="<?php echo $kodeCart ?>"
                            readonly>
                    </div>
                    ...
                    <div class="col-8 pl-0">
                        <input type="text" class="form-control form-control-sm bg-white" value="<?php echo $user ?>"
                            readonly>
                    </div>
                </div>
            </div>
        ...
        <form id="myCartNew" method="post">
            <div class="row print-none">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control form-control-sm bg-white" id="subtotal"
                            name="tambahcuy" onchange="total()" readonly>
                        <div class="input-group-append">
        ...
        <div class="d-none pt-5 px-4 print-show">
            ...
            WHERE p.idproduk=c.idproduk ORDER BY idcart ASC");
                ...
                <div class="col-12 text-center">
                    ...
                    <p class="h4 text-muted">Powered ujikom 2023</p>
                </div>
            </div><!-- end row -->
        </div><!-- end box print -->
